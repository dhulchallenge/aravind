...
{
    public class report_user_login_failure : user_syntax
    {
        ...
        [Test]
        public void given_five_failures_within_threshold_should_lock()
        {
        ...
        [Test]
        public void given_five_failures_outside_threshold_should_do_nothing()
        {
            Given(  new UserCreated(id, sec, fiveMins),
                        Failure(01),
                        Failure(02),
        ...
        [Test]
        public void five_failures_lock_and_unlock()
        {
            Given(new UserCreated(id, sec, fiveMins),
                        Failure(1),
                        Failure(2),
